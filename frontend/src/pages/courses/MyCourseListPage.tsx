  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Seguimiento de tus cursos</p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-800 truncate">{course.titulo}</p>
                  <div className="flex items-center gap-2 mt-1">
                    <UrgencyBadge fechaLimite={course.fecha_limite} />
                    {course.area_nombre && (
                      <span className="text-xs text-gray-400">{course.area_nombre}</span>
                    )}
                  </div>
                  {/* Thin progress bar */}
                  {activeTab === "EN_PROGRESO" && (
